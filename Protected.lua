local _ = loadstring(game:HttpGet("https://raw.githubusercontent.com/SkyOnTop/UI-Lib/main/main.lua"))()
local b = _:New({Name = "VisualWorks V2", FolderToSave = "SolarisLibStuff"})
local _ = b:Tab("Info")
local a = _:Section("Click for message")
local _ = b:Tab("Valkyrie")
local h = _:Section("Valkyrie")
local n = _:Section("Valkyrie Shades")
...
local _ = b:Tab("Faces")
local f = _:Section("Main Faces")
local d = _:Section("Beast Mode")
local ee = _:Section("Wistful Wink")
local e = _:Section("Bubble Trouble")
local ggg = _:Section("Galaxy Gaze")
local gg = _:Section("Glowing Eyes")
local g = _:Section("Other")
local m = b:Tab("Popular")
local _ = m:Section("Headless")
local v = m:Section("Korblox")
local pp = m:Section("Other")
local z = b:Tab("Custom")
local k = z:Section("Custom Asset")
local zz = b:Tab("Other")
local kk = zz:Section("Useful")
local ppppp = game:GetService("StarterGui")
ppppp:SetCore("SendNotification", {Title = "Discord", Text = "Copied to your clipboard", Duration = 10})
wait(0.5)
setclipboard("https://discord.gg/texks6KMRQ")
a:Button(
    "Credits",
    function()
        local _ = game:GetService("StarterGui")
        _:SetCore("SendNotification", {Title = "Creator", Text = "$ky#6354", Duration = 15})
    end
)
a:Button(
    "Discord Server",
...
pp:Button(
    "Agonizingly Red Bucket of Cheer",
    function()
        function l(a, _)
            local b = Instance.new("Weld")
            b.Part0 = a.Parent
...
ee:Button(
    ...
    function()
        ...
        _.Texture = "rbxassetid://583722710"
    end
)
ee:Button(
    "Green Wistful Wink",
    function()
        ...
        local _ = _:FindFirstChild("Head")
        local _ = _:FindFirstChild("face") or _:FindFirstChild("Face")
        _.Texture = "rbxassetid://583722932"
    end
)
ee:Button(
    "Blue Wistful Wink",
    function()
        ...
        local _ = _:FindFirstChild("Head")
        local _ = _:FindFirstChild("face") or _:FindFirstChild("Face")
        _.Texture = "rbxassetid://583721561"
    end
)
d:Button(
    "Beast Mode",
...
kk:Button(
    "Destroy Accessories",
    function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/SkyOnTop/UI-Lib/main/destroy.lua"))()
    end
)
f:Button(
    "Trouble Maker",
...
ggg:Button(
    ...
    function()
        ...
        local _ = _:FindFirstChild("Head")
        local _ = _:FindFirstChild("face") or _:FindFirstChild("Face")
        _.Texture = "rbxassetid://440738448"
    end
)
ggg:Button(
    "Purple Galaxy Gaze",
    function()
        ...
        local _ = _:FindFirstChild("Head")
        local _ = _:FindFirstChild("face") or _:FindFirstChild("Face")
        _.Texture = "rbxassetid://440739240"
    end
)
ggg:Button(
    "Blue Galaxy Gaze",
    function()
        ...
        local _ = _:FindFirstChild("Head")
        local _ = _:FindFirstChild("face") or _:FindFirstChild("Face")
        _.Texture = "rbxassetid://440739518"
    end
)
ggg:Button(
    "Green Galaxy Gaze",
    function()
        ...
        local _ = _:FindFirstChild("Head")
        local _ = _:FindFirstChild("face") or _:FindFirstChild("Face")
        _.Texture = "rbxassetid://440739783"
    end
)
g:Button(
    "I'm telling!",
...
g:Button(
    ...
    function()
        ...
        local _ = _:FindFirstChild("Head")
        local _ = _:FindFirstChild("face") or _:FindFirstChild("Face")
        _.Texture = "rbxassetid://362051899"
    end
)
g:Button(
    "Eyes of Azurewrath",
...
g:Button(
    ...
    function()
        ...
        local _ = _:FindFirstChild("Head")
        local _ = _:FindFirstChild("face") or _:FindFirstChild("Face")
        _.Texture = "rbxassetid://2222774106"
    end
)
g:Button(
    "Snow Queen Smile",
    function()
        ...
        local _ = _:FindFirstChild("Head")
        local _ = _:FindFirstChild("face") or _:FindFirstChild("Face")
        _.Texture = "rbxassetid://2569005011"
    end
)
f:Button(
    "ROBLOX Madness Face",
...
f:Button(
    ...
    function()
        ...
        local _ = _:FindFirstChild("Head")
        local _ = _:FindFirstChild("face") or _:FindFirstChild("Face")
        _.Texture = "rbxassetid://1213472762"
    end
)
g:Button(
    "Silver Punk Face",
...
gg:Button(
    ...
    function()
        ...
        local _ = _:FindFirstChild("Head")
        local _ = _:FindFirstChild("face") or _:FindFirstChild("Face")
        _.Texture = "rbxassetid://398676450"
    end
)
_:Button(
    "Headless",
